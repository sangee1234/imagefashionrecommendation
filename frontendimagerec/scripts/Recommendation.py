...
def get_similar_images(category, input_image):
  ...
  df = pd.read_csv("features_"+category+".csv")
  df['dist'] =  cdist(df.features, features, metric="cosine")
...
def run(
    ...
    return str(save_dir / 'crops')


def get_recommendations():
    print("1.......")
    res_directory = run(save_crop=True, source="test_image.jpg")
    categories = os.listdir(res_directory)
    for category in categories:
        print(category)
        images = os.listdir(res_directory+"/"+category)
        get_similar_images(category, Image.open(images[0]))
